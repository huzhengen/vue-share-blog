<template>
  <div id="detail">
    ...
    <section class="article">
      ...
      <p>
        CSS 网格布局(Grid Layout) 是CSS中最强大的布局系统。 这是一个二维系统，这意味着它可以同时处理列和行，不像
        <a
          href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/"
          target="_blank"
        >flexbox</a> 那样主要是一维系统。 你可以通过将CSS规则应用于父元素（成为网格容器）和该元素的子元素（网格元素），来使用网格布局。
      </p>
      <blockquote>
        <p>
          ...
          <a
            ...
            target="_blank"
          >Chris House</a> 的个人博客，由
          <a href="https://jirengu.com" target="_blank">饥人谷</a>
          <a href="https://www.zhihu.com/people/jirengu-ruo-yu" target="_blank">若愚老师</a>翻译
        </p>
      </blockquote>
      <h2 id="引言">引言</h2>
      <p>
      ...
      <p>
        有两个东西，启发我写这篇指南。 第一个是雷切尔·安德鲁（Rachel Andrew）的书
        <a
          href="http://abookapart.com/products/get-ready-for-css-grid-layout"
          target="_blank"
        >为CSS Grid布局准备</a>。 这本书对网格布局做了彻底、清晰的介绍，也是是整篇文章的基础，我强烈建议你购买并阅读他的书。 我的另一个重要灵感是Chris Coyier的
        <a
          href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/"
          target="_blank"
        >Flexbox完全指南</a>，当需要查阅 flexbox 的一切资料时我就会找这篇文章。 这篇文章帮助了很多人学习 Flex 布局，也是 Google 上搜索“flexbox”关键字排名第一的文章。你会发现他的文章和我的很多相似之处，有最好的范例在那放着为什么咱不偷师学着写呢？
      </p>
      ...
      <p>
        ...
        <code>grid-row</code>把它的子元素放入网格。 与flexbox类似，网格子元素的原始顺序不重要。 你的可以在 CSS 里以任意顺序放置它们，这使得使用媒体查询重新排列网格变得非常容易。 想象一下，我们需要定义整个页面的布局，然后为了适应不同的屏幕宽度完全重新排列，我们只需要几行CSS就能实现这个需求。 网格是有史以来最强大的CSS模块之一。
      </p>
      ...
      <blockquote>
        <p>
          浏览器支持的详细数据可在
          <a href="http://caniuse.com/#feat=css-grid" target="_blank">Caniuse</a>查看。其中里面的数字表示该版本以上的浏览器支持Grid。
        </p>
      </blockquote>
      ...
      <p>
        ...
        <code>.container</code> 就是是 grid container。
      </p>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"item item-1"</span>&gt;</span><span
  class="hljs-tag"
>&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"item item-2"</span>&gt;</span><span
  class="hljs-tag"
>&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"item item-3"</span>&gt;</span><span
  class="hljs-tag"
>&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      ...
      <p>
        Grid 容器的孩子（直接子元素）。下面的
        <code>.item</code> 元素就是 grid item，但
        <code>.sub-item</code>不是。
      </p>
      <pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"container"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"item"</span>&gt;</span><span
  class="hljs-tag"
>&lt;/<span class="hljs-name">div</span>&gt;</span> 
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"item"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"sub-item"</span>&gt;</span><span
  class="hljs-tag"
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      ...
      <ul>
        <li>
          <strong>grid</strong> - 生成一个块级(block-level)网格
        </li>
        <li>
          <strong>inline-grid</strong> - 生成一个行级(inline-level)网格
        </li>
        <li>
          <strong>subgrid</strong> - 如果你的 grid container 本身就是一个 grid item（即,嵌套网格），你可以使用这个属性来表示你想从它的父节点获取它的行/列的大小，而不是指定它自己的大小。
        </li>
      </ul>
  ...
  <span class="hljs-attribute">display</span>: grid | inline-grid | subgrid;
      ...
      <p>
        ...
        <code>float</code>,
        <code>clear</code>, 以及
        <code>vertical-align</code> 对一个 grid container 没有影响
      </p>
...
>grid-template-rows</span>: &lt;track-size&gt; ... | &lt;line-name&gt; &lt;track-size&gt; ...;
}
</code></pre>
      <p>例子:</p>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: <span class="hljs-number">25%</span> <span class="hljs-number">100px</span> auto;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/55281623.jpg" alt>
      </p>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: [row1-start] <span class="hljs-number">25%</span> [row1-end] <span class="hljs-number">100px</span> [third-line] auto [last-line];
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/1314820.jpg" alt>
      </p>
  ...
  <span class="hljs-attribute">grid-template-columns</span>: <span class="hljs-number">1</span>fr <span class="hljs-number">50px</span> <span class="hljs-number">1</span>fr <span class="hljs-number">1</span>fr;
      ...
      <p>
        通过引用
        <code>grid-area</code>属性指定的网格区域的名称来定义网格模板。 重复网格区域的名称导致内容扩展到这些单元格。 点号表示一个空单元格。 语法本身提供了网格结构的可视化。
      </p>
      <p>值：</p>
      <ul>
        <li>
          <code>&lt;grid-area-name&gt;</code> - 使用 grid-area 属性设置的网格区域的名称
        </li>
        <li>
          <code>.</code> - 点号代表一个空网格单元
        </li>
        <li>
          <strong>none</strong> - 没有定义网格区域
        </li>
      </ul>
      <p>举例：</p>
...
<span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-template-areas</span>: 
    ...
    <span class="hljs-string">"footer footer footer footer"</span>;
      ...
      <p>
        这将创建一个四列宽三行高的网格。 整个第一行将由
        <strong>header</strong> 区域组成。 中间一行将由两个
        <strong>main</strong> 区域、一个空单元格和一个
        <strong>sidebar</strong> 区域组成。 最后一行是
        <strong>footer</strong>区域组成。
      </p>
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/45883436.jpg" alt>
      </p>
      <p>你的声明中的每一行都需要有相同数量的单元格。</p>
      <p>
        您可以使用任意数量的相邻的
        <code>.</code>来声明单个空单元格。 只要这些点号之间没有空格，他们就代表了一个单一的单元格。
      </p>
      <p>
        需要注意的是你不是在用这个语法命名网格线，而是在命名区域。 当你使用这种语法时，区域两端的网格线实际上是自动命名的。 比如，如果网格区域的名称是foo，那么区域的起始的行网格线和列网格线名称是 foo-
        <strong>start</strong>，并且区域终点的行网格线和列网格线名称是 foo-
        <strong>end</strong>。 这意味着某些网格线可能有多个名称，比如上面的例子中最左边的一条网格线有三个名字：header-start，main-start 和 footer-start。
      </p>
      ...
      <ul>
        <li>
          <strong>none</strong> - 将三个属性都设置为其初始值
        </li>
        <li>
          <strong>subgrid</strong> - 把 grid-template-rows 和 grid-template-columns 设置为 subgrid, 并且 grid-template-areas 设置为初始值
        </li>
        <li>
          <code>grid-template-rows</code> /
          <code>&lt;grid-template-columns</code> - 把 grid-template-columns 和 grid-template-rows 设置为指定值, 与此同时, 设置 grid-template-areas 为 none
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-row-gap</span>: <span class="hljs-number">15px</span>;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/406531.jpg" alt>
      </p>
  ...
  <span class="hljs-attribute">grid-gap</span>: <span class="hljs-number">10px</span> <span class="hljs-number">15px</span>;
      ...
      <ul>
        <li>
          <strong>start</strong>: 内容与网格区域的左端对齐
        </li>
        <li>
          <strong>end</strong>: 内容与网格区域的右端对齐
        </li>
        <li>
          <strong>center</strong>: 内容位于网格区域的中间位置
        </li>
        <li>
          <strong>stretch</strong>: 内容宽度占据整个网格区域空间(这是默认值)
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">justify-items</span>: start;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/81852061.jpg" alt>
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span>{
  <span class="hljs-attribute">justify-items</span>: end;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/57749032.jpg" alt>
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: center;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/73568687.jpg" alt>
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: stretch;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/81147184.jpg" alt>
      </p>
      <p>
        也可以通过给单个 grid item 设置
        <code>justify-self</code>属性来达到上述效果。
      </p>
      ...
      <ul>
        <li>
          <strong>start</strong>: 内容与网格区域的顶端对齐
        </li>
        <li>
          <strong>end</strong>: 内容与网格区域的底部对齐
        </li>
        <li>
          <strong>center</strong>: 内容位于网格区域的垂直中心位置
        </li>
        <li>
          <strong>stretch</strong>: 内容高度占据整个网格区域空间(这是默认值)
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">align-items</span>: start;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/31201904.jpg" alt>
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: end;
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-11/37389909.jpg" alt>
      </p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: center;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-11/64308393.jpg"
  ...
  <span class="hljs-attribute">align-items</span>: stretch;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-11/33767654.jpg"
          alt="Example of align-items set to stretch"
        >
      </p>
      <p>
        也可以通过给单个 grid item 设置
        <code>align-self</code>属性来达到上述效果。
      </p>
  ...
  <span class="hljs-attribute">justify-content</span>: start;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-18/16621438.jpg"
  ...
  <span class="hljs-attribute">justify-content</span>: end; 
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-11/46252522.jpg"
  ...
  <span class="hljs-attribute">justify-content</span>: center;  
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-11/31369605.jpg"
  ...
  <span class="hljs-attribute">justify-content</span>: stretch; 
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-11/65452171.jpg"
  ...
  <span class="hljs-attribute">justify-content</span>: space-around;  
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/79036314.jpg"
  ...
  <span class="hljs-attribute">justify-content</span>: space-between; 
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/36148565.jpg"
  ...
  <span class="hljs-attribute">justify-content</span>: space-evenly;  
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/9095829.jpg"
  ...
  <span class="hljs-attribute">align-content</span>: end; 
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/15060507.jpg"
  ...
  <span class="hljs-attribute">align-content</span>: center;  
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/72396881.jpg"
  ...
  <span class="hljs-attribute">align-content</span>: stretch; 
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/46794685.jpg"
  ...
  <span class="hljs-attribute">align-content</span>: space-around;  
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/81192919.jpg"
  ...
  <span class="hljs-attribute">align-content</span>: space-between; 
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/27437729.jpg"
  ...
  <span class="hljs-attribute">align-content</span>: space-evenly;  
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/6825571.jpg"
      ...
      <ul>
        <li>
          <code>&lt;track-size&gt;</code> - 可以是一个长度值，一个百分比值，或者一个自由空间的一部分（使用 fr 单位）
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-template-rows</span>: <span class="hljs-number">90px</span> <span class="hljs-number">90px</span>
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-12/90644000.jpg" alt="Example of 2 x 2 grid">
      </p>
      <p>这里创建了一个 2x2的网格。</p>
...
<span class="hljs-selector-class">.item-b</span> {
  ...
  <span class="hljs-attribute">grid-row</span>: <span class="hljs-number">2</span> / <span class="hljs-number">3</span>;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/38445302.jpg"
  ...
  <span class="hljs-attribute">grid-auto-columns</span>: <span class="hljs-number">60px</span>;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/33573866.jpg"
          alt="Example of implicit tracks"
        >
      </p>
  ...
  <span class="hljs-attribute">grid-auto-flow</span>: row | column | row dense | column dense
      ...
      <p>
        需要注意的是，
        <code>dense</code> 可能导致您的 grid item 乱序。
      </p>
      <p>举例， 考虑如下 HTML：</p>
...
<span class="hljs-selector-class">.item-e</span> {
  ...
  <span class="hljs-attribute">grid-row</span>: <span class="hljs-number">1</span> / <span class="hljs-number">3</span>;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/92242678.jpg"
  ...
  <span class="hljs-attribute">grid-auto-flow</span>: column;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/55339887.jpg"
      ...
      <ul>
        ...
        <li>
          <code>&lt;grid-template-rows&gt;</code> /
          <code>&lt;grid-template-columns&gt;</code> - 将 grid-template-rows 和 grid-template-columns 分别设置为指定值，将所有其他子属性设置为其初始值
        </li>
        <li>
          <code>&lt;grid-auto-flow&gt;</code> [
          <code>&lt;grid-auto-rows&gt;</code> [ /
          <code>&lt;grid-auto-columns&gt;</code>] ] - 接受所有与grid-auto-flow，grid-auto-rows和grid-auto-columns相同的值。 如果省略grid-auto-columns，则将其设置为为grid-auto-rows指定的值。 如果两者都被省略，则它们被设置为它们的初始值
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
...
<span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-template-columns</span>: auto <span class="hljs-number">50px</span> auto;    
      ...
      <h3
        id="grid-column-start--grid-column-end--grid-row-start-grid-row-end"
      >grid-column-start / grid-column-end / grid-row-start /grid-row-end</h3>
      ...
      <ul>
        <li>
          <code>&lt;line&gt;</code>: 可以是一个数字来指代相应编号的网格线，也可使用名称指代相应命名的网格线
        </li>
        <li>
  ...
  grid-row-end: <span class="hljs-number">3</span>
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/8301648.jpg"
  ...
  grid-row-end: span <span class="hljs-number">2</span>
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/35742447.jpg"
          alt="Example of grid-row/column-start/end"
        >
      </p>
      ...
      <ul>
        <li>
          ...
          <code>&lt;end-line&gt;</code> - 每个值的用法都和属性分开写时的用法一样
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item</span> {
  ...
  <span
  class="hljs-attribute"
>grid-row</span>: &lt;start-line&gt; / &lt;end-line&gt; | &lt;start-line&gt; / span &lt;value&gt;;
}
</code></pre>
      <p>举例：</p>
  ...
  <span class="hljs-attribute">grid-row</span>: third-line / <span class="hljs-number">4</span>;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/95036015.jpg"
      ...
      <ul>
        ...
        <li>
          ...
          <code>&lt;row-end&gt;</code> /
          <code>&lt;column-end&gt;</code> - 可以是数字，也可以是网格线的名字
        </li>
      </ul>
      <pre><code class="lang-css"><span class="hljs-selector-class">.item</span> {
  ...
  <span class="hljs-attribute">grid-area</span>: <span class="hljs-number">1</span> / col4-start / last-line / <span class="hljs-number">6</span>
      ...
      <p>
        <img src="https://cloud.hunger-valley.com/18-1-12/37070111.jpg" alt="Example of grid-area">
      </p>
  ...
  <span class="hljs-attribute">justify-self</span>: start;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/53670315.jpg"
  ...
  <span class="hljs-attribute">justify-self</span>: end;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/15608697.jpg"
  ...
  <span class="hljs-attribute">justify-self</span>: center;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/42777942.jpg"
  ...
  <span class="hljs-attribute">justify-self</span>: stretch;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/42754838.jpg"
  ...
  <span class="hljs-attribute">align-self</span>: start;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/67517511.jpg"
  ...
  <span class="hljs-attribute">align-self</span>: end;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/9140938.jpg"
  ...
  <span class="hljs-attribute">align-self</span>: center;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/38240821.jpg"
  ...
  <span class="hljs-attribute">align-self</span>: stretch;
      ...
      <p>
        <img
          src="https://cloud.hunger-valley.com/18-1-12/84502177.jpg"
